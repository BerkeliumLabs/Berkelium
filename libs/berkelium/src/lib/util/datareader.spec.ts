...
describe('Read CSV file', () => {
    ...
    it('should correctly parse a CSV string into an array of objects', () => {
        ...
        const expectedOutput = [
            ...
            { "Name": "Nimal Jayasinghe", "City": "Kandy", "Age": "34", "Monthly Income": "", "Date of Birth": "1990-03-22" },
            { "Name": "Pathum Silva", "City": "Negombo", "Age": "45", "Monthly Income": "85000", "Date of Birth": "1979-09-30" },
            { "Name": "Sanduni Fernando", "City": "Galle", "Age": "", "Monthly Income": "70000", "Date of Birth": "1994-02-15" },
